...
import {
    ...
    percentual_por_categoria, soma_vetor, show_menu_resultado,
    total_votos_perc_de_cada_candidato, total_branco_perc,
...
function main() {
    ...
    while(opcao_menu !== 0){
        if(opcao_menu === 1){
            ...
            console.clear()
            total_votos_perc_de_cada_candidato(vetor_votos, vetor_candidatos, percentual)
            input('<enter> to continue')
        }
            ...
            console.clear()
            //tem segundo turno se percentual de votos validos de um candidato não
            //atingir 51% dos votos (votos validos excluem os votos: Brancos, nulos, nao opinam)
